...
void Tetrahedron::setVertexData() {
    ...
    /// 3) triangle ADB
    glm::vec3 normal_adb = glm::cross( (v_b-v_a), (v_d-v_a) );
    /// 4) triangle BCD
    ...
    ////////////// This normal was pointing the oposite direction
    ...
    insertVec3(m_vertexData, m_color);
...
void Tetrahedron::updateParams(int param1, int param2) {
